 ...
 * Versión mejorada con mejor visualización de cards y logo prominente
 */
...
$rutaJS = 'js/main.js';
$rutaDashboardCSS = 'css/dashboard.css'; // Archivo CSS específico para el dashboard
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <link href="<?php echo $rutaDashboardCSS; ?>" rel="stylesheet">
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">
                <img src="images/logo_procuraduria.png" alt="Logo PROCURADURIA AGRARIA" class="d-inline-block align-top">
                <!-- El texto del logo se eliminó ya que está en la imagen -->
            </a>
            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5><i class="fas fa-tachometer-alt me-2"></i>PANEL DE CONTROL</h5>
                    </div>
                    <div class="card-body">
                        <!-- Tarjetas de resumen mejoradas -->
                        <div class="row dashboard-cards-row">
                            <?php
                            // Consultar cantidad de trámites activos
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card card-dashboard border-primary h-100">
                                    <!-- Indicador de estado como contador en la esquina -->
                                    <div class="status-counter counter-info"><?php echo $totalActivos; ?></div>
                                    <div class="card-body text-center py-4">
                                        <div class="icon-container">
                                            <i class="fas fa-file-alt display-icon text-primary"></i>
                                        </div>
                                        <h5 class="card-title">TRÁMITES ACTIVOS</h5>
                                        <div class="counter-display"><?php echo $totalActivos; ?></div>
                                        <a href="paginas/listado-tramites.php?filtro=activos" class="btn btn-outline-primary btn-card-action">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card card-dashboard border-info h-100">
                                    <!-- Indicador de estado como contador en la esquina -->
                                    <div class="status-counter counter-warning"><?php echo $totalPrevenidos; ?></div>
                                    <!-- Cinta para indicador de estado -->
                                    <?php if ($totalPrevenidos > 0): ?>
                                    <div class="status-ribbon ribbon-warning">ATENCIÓN</div>
                                    <?php endif; ?>
                                    <div class="card-body text-center py-4">
                                        <div class="icon-container">
                                            <i class="fas fa-exclamation-circle display-icon text-info"></i>
                                        </div>
                                        <h5 class="card-title">PREVENIDOS</h5>
                                        <div class="counter-display"><?php echo $totalPrevenidos; ?></div>
                                        <a href="paginas/listado-tramites.php?filtro=prevenidos" class="btn btn-outline-info btn-card-action">
                                            <i class="fas fa-eye me-1"></i>VER DETALLES
                                        </a>
                                    </div>
                                </div>
                            ...
                            ?>
                            <div class="col-md-3 mb-4">
                                <div class="card card-dashboard border-danger h-100">
                                    <!-- Indicador de estado como contador en la esquina -->
                                    <div class="status-counter counter-danger"><?php echo $totalReiteracion; ?></div>
                                    <!-- Cinta para indicador de estado -->
                                    <?php if ($totalReiteracion > 0): ?>
                                    <div class="status-ribbon ribbon-danger">URGENTE</div>
                                    <?php endif; ?>
                                    <div class="card-body text-center py-4">
                                        <div class="icon-container">
                                            <i class="fas fa-exclamation-triangle display-icon text-danger"></i>
                                        </div>
                                        <h5 class="card-title">POR REITERARSE</h5>
                                        <div class="counter-display"><?php echo $totalReiteracion; ?></div>
                                        <a href="paginas/reporte-reiteraciones.php" class="btn btn-outline-danger btn-card-action">
                                            <i class="fas fa-eye me-1"></i>VER DETALLES
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card card-dashboard border-success h-100">
                                    <!-- Indicador de estado como contador en la esquina -->
                                    <div class="status-counter counter-success"><?php echo $totalCompletados; ?></div>
                                    <!-- Cinta para indicador de estado si el número es significativo -->
                                    <?php if ($totalCompletados > 10): ?>
                                    <div class="status-ribbon ribbon-active">COMPLETADOS</div>
                                    <?php endif; ?>
                                    <div class="card-body text-center py-4">
                                        <div class="icon-container">
                                            <i class="fas fa-check-circle display-icon text-success"></i>
                                        </div>
                                        <h5 class="card-title">COMPLETADOS</h5>
                                        <div class="counter-display"><?php echo $totalCompletados; ?></div>
                                        <a href="paginas/listado-tramites.php?filtro=completados" class="btn btn-outline-success btn-card-action">
                                            <i class="fas fa-eye me-1"></i>VER DETALLES
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="card search-card border-primary">
                                    <div class="card-header bg-primary text-white">
